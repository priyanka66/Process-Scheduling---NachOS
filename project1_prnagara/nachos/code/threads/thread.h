...
class Thread {
  ...
  public:
    ...
    void Fork(Process *p,VoidFunctionPtr func, void *arg); 				// Make thread run (*func)(arg)
    void Yield();  		// Relinquish the CPU if any 
     void Yield(Process *p); 				// other thread is runnable
    void Sleep(bool finishing); // Put the thread to sleep and 
    void Sleep(Process *p, bool finishing);				// relinquish the processor
...
extern void ThreadIDPrint(Thread *thread);
